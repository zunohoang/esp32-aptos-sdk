...
// Network endpoints
#define APTOS_MAINNET "https://api.mainnet.aptoslabs.com/v1"
#define APTOS_TESTNET "https://api.testnet.aptoslabs.com/v1"
#define APTOS_DEVNET "https://api.devnet.aptoslabs.com/v1"
